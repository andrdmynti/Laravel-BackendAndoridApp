...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('asset/datatables/dataTables.bootstrap4.css')); ?>">
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="row">
      ...
      <div class="col-sm-8">INI ADALAH ISI DARI KONTEN</div>
    </div>
  </div>
</body>
</html>
    ...
    <script src="<?php echo e(url('asset/js/sb-admin.min.js')); ?>"></script>
    <!-- Custom scripts for this page-->
    <script src="<?php echo e(url('asset/js/sb-admin-datatables.min.js')); ?>"></script>
    <script src="<?php echo e(url('asset/js/sb-admin-charts.min.js')); ?>"></script>