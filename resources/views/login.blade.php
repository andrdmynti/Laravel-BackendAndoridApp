...
<body class="bg-dark">
  <div class="container">
      ...
      <div class="card-body">
        ...
        {{ csrf_field() }}
          ...
          <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
            ...
            <input class="form-control" id="exampleInputEmail1" type="email" name="email" value="{{ old('email') }}" aria-describedby="emailHelp" placeholder="Enter email" required>
          </div>
    ...
    <script src="{{url('vendor/vendor/jquery/jquery.min.js')}}"></script>
    <script src="{{url('vendor/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
    <!-- Core plugin JavaScript-->
    <script src="{{url('vendor/vendor/jquery-easing/jquery.easing.min.js')}}"></script>